        ...
        <div class=" modal-content mt-5 " v-for="project in projects" :key="project.id">
          ...
          <p v-if="!isEditModalOpen">
            ...
            <Transition v-if="closeEditModal">
              <div class=" bg-gray-100 p-10  modal" v-if="isEditModalOpen && selectedProject === project.id">
                <div class="flex justify-end px-9">
                  <button class="font-semibold text-red-400 btn-close mb-10" @click="closeEditModal">Close</button>
                </div>
                <div class=" grid md:grid-cols-2 gap-10">
                  ...
                  <div>
                    ...
                    <p class="" >
                      <input class="border-2 rounded-md" type="text" placeholder="New project name" v-model="project.projectName" />
                    </p>
                  </div>
                  ...
                  <div>
                    <p>projectTeam: </p>
                    <p>
                      <input class="border-2 rounded-md" type="text" placeholder="project Team" v-model="project.projectTeam" />
                    </p>
                  </div>
              </div>
                <p>
                ...
                <div class="bg-gray-200">
                  ...
                  <h2 class="pb-2 px-3">selected Categories: {{ project.projectCategory.join(', ') }}</h2> 
                    <div class="text-left p-3 grid grid-cols-2">
                ...
                <div class="h-1/2 w-1/2">
                  <img class="object-cover" v-if="project.projectImg" :src="project.projectImg" alt="Project Image" />
                </div>
